...
A version of this library is on QuickLisp, which includes some but not
all functionality. It includes the =generate=, =each= (element-wise
...
This fork of the [[https://github.com/tpapp/array-operations][original library]] adds =each-index=, =sum-index=,
=vectorize= (a version of which was also in an [[https://github.com/tpapp/array-operations-old][older library]]),
